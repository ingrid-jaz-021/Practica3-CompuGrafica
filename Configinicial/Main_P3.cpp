...
int main() {
 ...
 //     
	...
	glm::mat4 projection=glm::mat4(1); // Matrices

	projection = glm::perspective(45.0f, (GLfloat)screenWidth / (GLfloat)screenHeight, 0.1f, 100.0f);//FOV, Radio de aspecto,znear,zfar - Tipo perspectiva
	//projection = glm::ortho(0.0f, (GLfloat)screenWidth, 0.0f, (GLfloat)screenHeight, 0.1f, 1000.0f);//Izq,Der,Fondo,Alto,Cercania,Lejania - Tipo orthogonal
	while (!glfwWindowShouldClose(window))
	{
		...
		// Mandar la info al Shader y dibujar
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
